...
*Note that for these properties of the Laplacian matrix to hold, it must be Symetric SPD, which in the directed case, it usually isn't. In this case we approximate to the nearest
symetric matrix with 1/2 * A A^T to ensure consistent analysis.*
